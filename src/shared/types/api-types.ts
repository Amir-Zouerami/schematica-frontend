...
export interface paths {
    ...
    "/api/v2/notifications/read-all": {
         ...
         */
        post: operations["NotificationController_markAllAsRead_v2"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        CreateProjectDto: {
            ...
            description?: string;
            servers?: components["schemas"]["ServerDto"][];
        ...
        ProjectAccessControlListResponseDto: {
            ...
            users: components["schemas"]["SanitizedUserDto"][];
        ...
        ProjectAccessDetailsResponseDto: {
            ...
            owners: components["schemas"]["ProjectAccessControlListResponseDto"];
            /** @description Users and Teams with Viewer (Read-only) access. */
            viewers: components["schemas"]["ProjectAccessControlListResponseDto"];
            /** @description Users explicitly denied access, overriding team membership. */
            deniedUsers: components["schemas"]["SanitizedUserDto"][];
        };
        ProjectDetailDto: {
            id: string;
            name: string;
            description: string | null;
            servers: components["schemas"]["ProjectServerDto"][] | null;
            ...
            access?: components["schemas"]["ProjectAccessDetailsResponseDto"];
            /** Format: date-time */
            createdAt: string;
            /** Format: date-time */
            updatedAt: string;
        ...
        AccessUserValidationDto: {
            id: string;
            username?: string;
            profileImage?: string;
        };
        AccessTeamValidationDto: {
            id: string;
            name?: string;
            createdAt?: string;
            updatedAt?: string;
        };
        ProjectAccessControlListInputDto: {
            users?: components["schemas"]["AccessUserValidationDto"][];
            teams?: components["schemas"]["AccessTeamValidationDto"][];
        };
        UpdateAccessDto: {
            owners?: components["schemas"]["ProjectAccessControlListInputDto"];
            viewers?: components["schemas"]["ProjectAccessControlListInputDto"];
            deniedUsers?: components["schemas"]["AccessUserValidationDto"][];
            lastKnownUpdatedAt: string;
        };
        EndpointSummaryDto: {
            id: string;
...
export interface operations {
    ...
    NotificationController_markAllAsRead_v2: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
