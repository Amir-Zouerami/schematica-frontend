			...
			{projects.length === 0 ? (
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					{projects.map((project: ProjectSummaryDto) => (
						// We will need to update ProjectCard to accept ProjectSummaryDto
						// but for now the structure is compatible enough.
						<ProjectCard
							key={project.id}
							project={project as any} // Temporary cast until we update ProjectCard
